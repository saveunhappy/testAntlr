...
public class DslParserTest {
    ...
    public void testCalculateDiscount() throws Exception {
        ...
        Object result = parser.parse("discount.dsl", dsl);
        assertTrue(result instanceof DslScript, "解析结果应该是DslScript类型");
        ...
        Object execResult = visitor.visit((org.antlr.v4.runtime.tree.ParseTree) script.getFunction("calculateDiscount").getBody());
        System.out.println("discount result: " + execResult);
        assertEquals(80.0, execResult); // PROD001 20%折扣，VIP更低，最终80
    }
    ...
    public void testCalculatePrice() throws Exception {
        ...
        DslParser parser = new DslParser();
        Object result = parser.parse("pricing.dsl", dsl);
        assertTrue(result instanceof DslScript, "解析结果应该是DslScript类型");
        DslScript script = (DslScript) result;
        ...
        Object execResult = visitor.visit((org.antlr.v4.runtime.tree.ParseTree) script.getFunction("calculatePrice").getBody());
        System.out.println("price result: " + execResult);
    ...
    public void testLogicAllSyntax() throws Exception {
        ...
        DslParser parser = new DslParser();
        Object result = parser.parse("logic.dsl", dsl);
        assertTrue(result instanceof DslScript, "解析结果应该是DslScript类型");
        DslScript script = (DslScript) result;
        
        BusinessDslVisitorImpl visitor = new BusinessDslVisitorImpl("logic.dsl");
        Object execResult = visitor.visit((org.antlr.v4.runtime.tree.ParseTree) script.getFunction("logicTest").getBody());
        assertNotNull(execResult);
        assertTrue(execResult instanceof Map);
        Map<?,?> map = (Map<?,?>) execResult;
